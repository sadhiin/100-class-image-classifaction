...
if __name__ == '__main__':
    ...
    args.add_argument('-n', '--project_name',
                      default='DLProject', help='Project Name')
    args.add_argument('--author', default='Sadhin', help='Author Name')

    parsed_args = args.parse_args()
    logging.info(
        f"Creating the project {parsed_args.project_name} by {parsed_args.author}")
    ...
    for dir_ in list_of_dir:
        ...
        if filedir:
            ...
            logging.info(
                f"Created the directory {filedir} for the file --> {filename}")
